...
int main()
{
	...
	printf("Entre com o nlparameter min e max\n");
	scanf("%f %f",&nlparametermin,&nlparametermax);
...
/*====================CRIACAO DO ARQUIVO DE SAIDA====================*/
	char filename1[250];
	FILE *fil1;
	sprintf(filename1,"X S%.2f t%d nli %.2f nlf %.2f Fw=%.2f F0=%.2f.dat",Sigma,tmax,nlparametermin,nlparametermax,Fw,F0);
